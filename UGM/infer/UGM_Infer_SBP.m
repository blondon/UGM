function [nodeBel,edgeBel,logZ,H] = UGM_Infer_CountBP(nodePot,edgePot,edgeStruct,nodeCount,edgeCount,auxCount)
...
if nargin < 6
	...
	if isfield(edgeStruct,'auxCount')
		auxCount = edgeStruct.auxCount;
	else
		error('UGM_Infer_CountBP : requires edgeStruct.auxCount or as 6th argument.')
	end
end
